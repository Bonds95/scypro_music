...
export const PlaylistTrackTitleSvg = styled.svg`
  ...
  stroke: #4e4e4e;
`;
export const PlaylistTrackTitleText = styled.div``;
export const PlaylistTrackTitleLink = styled.a`
  ...
  color: #ffffff;
`;
export const PlaylistTrackTitleSpan = styled.span`
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
  line-height: 24px;
...
export const PlaylistTrackAlbumLink = styled.a`
  ...
  color: #696969;
`;
export const PlaylistTrackTime = styled.div``;
export const PlaylistTrackTimeSvg = styled.svg`
  width: 14px;
  height: 12px;
  margin-right: 17px;
  fill: transparent;
  stroke: #696969;
`;
export const PlaylistTrackTimeText = styled.span`
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
  line-height: 24px;
